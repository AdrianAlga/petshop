      ...
      <div class="row align-items-center h-100 text-center">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <div>
                <img src="{{ asset('/images/wel3.png') }}" alt="img" />
              </div>
            </div>
            <div class="col-md-12">
              <h2 class="py-3">Relax</h2>
              <p class="py-3">Kami memberikan kenyamanan kepada hewan kesayangan anda melalui fasilitas terbaik dari
                kami
              </p>
